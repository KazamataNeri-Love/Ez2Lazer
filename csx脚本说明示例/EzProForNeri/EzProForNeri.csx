...
public class EzProForNeri : Skin
{
    public static SkinInfo CreateInfo() => new SkinInfo
    {
        Name = "-方砖-风又音理-",
        Creator = "(SK_la & SeriousDucKing)",
        Protected = true,
        InstantiationInfo = typeof(EzProForNeri).GetInvariantInstantiationInfo()
    };

    protected EzResourceStore? EzResources;

    public EzProForNeri(IStorageResourceProvider resources)
        : this(CreateInfo(), resources)
    {
    }

    [UsedImplicitly(ImplicitUseKindFlags.InstantiatedWithFixedConstructorSignature)]
    public EzProForNeri(SkinInfo skin, IStorageResourceProvider resources, IResourceStore<byte[]>? fallbackStore = null)
